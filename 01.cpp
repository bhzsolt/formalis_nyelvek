...
int main(int argc, const char *argv[])
{
	...
	try {
		...
		Automaton test = automaton.exclude_useless2();
		std::cout << test;
		BREAK();

		Automaton test2 = automaton;
		test2.exclude_useless();
		std::cout << test2;
		BREAK();

		Automaton test3 = automaton.exclude_unreachable2();
		std::cout << test3;
		BREAK();
		...
		*/
		...
		//automaton1.print_test(cerr);
		Automaton automaton2(argv[2]);
		//automaton2.print_test(cerr);
